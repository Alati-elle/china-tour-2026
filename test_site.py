...
with sync_playwright() as p:
    ...
    for selector in ("#refreshDayWeather",):
        check(selector+" disabled",page.locator(selector).is_disabled(),page.locator(selector).get_attribute("title") or "")
        check(selector+" hint",hint in (page.locator(selector).get_attribute("title") or ""),page.locator(selector).get_attribute("title") or "")
    check("weather archive status","Архив" in weather_status or "архив" in weather_status,weather_status)
