...
with sync_playwright() as p:
  ...
  check('packing file buttons compact',page.locator('#exportPacking').bounding_box()['height']<=38 and page.locator('#importPackingButton').bounding_box()['height']<=38)
  ...
  check('impression file buttons compact',page.locator('#exportImpressions').bounding_box()['height']<=38 and page.locator('#importImpressionsButton').bounding_box()['height']<=38)
